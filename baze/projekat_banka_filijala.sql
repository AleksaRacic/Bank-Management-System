...
CREATE TABLE `filijala` (
  ...
  KEY `FK_filijala_idMesto_idx` (`idMesto`),
  CONSTRAINT `FK_filijala_idMesto` FOREIGN KEY (`idMesto`) REFERENCES `mesto` (`idMesto`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `filijala` VALUES (1,'Meksickih Boraca','Filijala1',1);
